...
function LeftWorkComponent(props) {
  return (
    <div className="w-[65%] h-[80%] translate-y-6 relative">
        ...
        <div className={`w-[90%] h-full bg-white rounded-[20px] persMoveLeft flex flex-col ${props.animationClass}`}>
            <div className='w-full h-[85%] flex items-center justify-center'>
                <div className='w-[99%] h-[99%] bg-black rounded-[20px]'></div>
            </div>
            <div className='w-full h-[15%] flex flex-col items-start px-4 py-2'>
